...
const { Blockchain, Transaction: Transaction } = require('./chikecoin_3');
...
const tx1 = new Transaction(myWalletAddress, 'Public key goes here', 10, Date.now());
...
const tx2 = new Transaction(myWalletAddress, 'Public key goes here', 20, Date.now());
